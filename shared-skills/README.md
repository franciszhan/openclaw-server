...
Do not leave user-specific context files in this shared bundle. Install those into the target user's workspace and activate them from that user's `AGENTS.md`.
